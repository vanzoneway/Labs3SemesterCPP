...
requires
(
        (std::is_same<type_of_key, std::string>::value || std::is_same<type_of_key, int>::value)
        && (std::is_same<type_of_value, std::string>::value || std::is_same<type_of_value, int>::value)
)
